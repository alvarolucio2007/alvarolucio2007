...
- 🛠️ **Environment:** CachyOS (Arch-based) + LazyVim (Neovim)
...
- 🛠️ **Setup:** CachyOS (Baseado em Arch) + LazyVim (Neovim)
...
- 🛠️ **Umgebung:** CachyOS (Arch-basiert) + LazyVim (Neovim)
...
![Docker](https://img.shields.io/badge/docker-%230073ec.svg?style=for-the-badge&logo=docker&logoColor=white)
...
<div align="left">
  <a href="mailto:alvarolucio2007.dev@gmail.com">
